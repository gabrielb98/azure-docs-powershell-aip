...
For more information, see Decommissioning and deactivating Azure Rights Management (https://docs.microsoft.com/rights-management/deploy-use/decommission-deactivate) on the Microsoft documentation site.
