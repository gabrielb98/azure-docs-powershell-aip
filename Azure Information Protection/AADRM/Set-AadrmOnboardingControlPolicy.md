...
If you use the assigned license option, you can assign licenses to users by using the Microsoft 365 admin center or by using Azure PowerShell and the [Set-MsolUserLicense](/powershell/module/msonline/set-msoluserlicense) cmdlet from the Azure AD PowerShell administration module. You can also use the [Get-MsolAccountSku](/powershell/module/msonline/get-msolaccountsku) cmdlet to obtain the different types of licenses that you can assign in your organization.
