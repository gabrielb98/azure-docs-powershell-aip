...
Similar configuration information can also be done when you create or configure a custom template in the Azure classic portal, but this cmdlet offers more fine-grained control.
