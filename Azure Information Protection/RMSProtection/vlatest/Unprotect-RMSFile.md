...
If you do not specify this parameter, the log files **Success.log**, **Failure.log**, and **Debug.log** are written to the default log file location of %localappdata%\Microsoft\MSIPC\pscmdlet\Logs.
